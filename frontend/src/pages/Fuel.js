...
function SectionLabel({ children }) {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "16px" }}>
      <span style={{ fontSize: "11px", fontWeight: "700", color: "#8892b0", letterSpacing: "0.08em", textTransform: "uppercase" }}>{children}</span>
      <div style={{ flex: 1, height: "1px", background: "#e8e9ee" }}></div>
    </div>
  );
}
...
function Fuel() {
  ...
  return (
    <div style={{ padding: "30px", background: "#f5f6fa", minHeight: "100vh" }}>
      ...
      {lowFuel.length > 0 && (
        <div style={{ background: "#fde8e8", border: "1px solid #f5c0c0", borderRadius: "12px", padding: "16px 20px", marginBottom: "32px", display: "flex", alignItems: "center", gap: "12px" }}>
          <span style={{ fontSize: "13px", fontWeight: "700", color: "#a32d2d", letterSpacing: "0.05em", textTransform: "uppercase" }}>Warning</span>
          <div>
      ...
      <section>
        <SectionLabel>Vehicle Detail</SectionLabel>
        <div style={{ background: "#fff", borderRadius: "14px", padding: "24px", boxShadow: "0 2px 12px rgba(0,0,0,0.06)" }}>
